...
class ValidationTest {
    ...
    // BEGIN
    @Test
    void testAdvancedValid() {
        Address address = new Address("Russia", "Uf", "Lenina", null, "63");
        var expected = Map.of(
                "city", new ArrayList<>(List.of("length less than 3")),
                "houseNumber", new ArrayList<>(List.of("can not be null")));
        assertThat(Validator.advancedValidate(address)).isEqualTo(expected);
    }
    // END
}
