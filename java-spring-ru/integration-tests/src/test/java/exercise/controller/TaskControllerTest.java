...
class ApplicationTest {
    ...
    public void testUpdate() throws Exception {
        ...
        var response = mockMvc.perform(get("/tasks/" + task.getId()))
                .andReturn().getResponse().getContentAsString();
        assertThatJson(response).and(a -> a.node("title").isEqualTo("new Title"));
    ...
    public void testDelete() throws Exception {
        ...
        var response = mockMvc.perform(get("/tasks")).andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
        assertThat(response).doesNotContain(task.getDescription(), task.getTitle());
    }
    // END
}
